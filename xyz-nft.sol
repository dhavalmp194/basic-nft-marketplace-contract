...
contract XYZNftToken is ERC721Enumerable, Ownable{
    using Strings for uint256;
    ...
    function bulkMint(uint256 _noOfTokensToMint, uint256 _amount) public {
    ...
    function withdrawFund(address destination) public onlyOwner {
